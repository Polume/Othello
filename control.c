...
{
    /* retour_au_coup_precedent (CTRL - Z) + retour_au_coup_suivant (CTRL - Y)  + musique (ON/OFF) + mode */
...
void interaction_barre(SDL_Window* window, SDL_Renderer* renderer, SDL_Event * e, points * pts_barre, int * menu_barre)
{
    ...
    printf("oui !! %d\n", *menu_barre);
    if(*menu_barre == 1)// Fichier : nouveau (CTRL - N) + ouvrir (CTRL - O) + enregistrer (CTRL - S) + enregistrer_sous (CTRL - GMAJ - S) + quitter (q) ----------------------------------
    {
    ...
    else if(*menu_barre == 2)// Option : retour_au_coup_precedent (CTRL - Z) + retour_au_coup_suivant (CTRL - Y)  + musique (ON/OFF) + mode ----------------------------------
    {
        ...
        else if((pts_ext[1].x1 < mouse_x && mouse_x < pts_ext[1].x2) && // Option->retour_au_coup_suivant
        ...
        else if((pts_ext[2].x1 < mouse_x && mouse_x < pts_ext[2].x2) && // Option->musique
                (pts_ext[2].y1 < mouse_y && mouse_y < pts_ext[2].y2))   // pts_ext[2] de Option
        {
            event.type = SDL_KEYDOWN;
            event.key.keysym.sym = SDLK_z;
            *e = event;
        ...
        else if((pts_ext[3].x1 < mouse_x && mouse_x < pts_ext[3].x2) && // Option->Mode
    ...
    printf("\nmouse_x : %d, mouse_y : %d\nx1 : %d, y1 : %d\nx1 : %d, y1 : %d\n", mouse_x,mouse_y,pts_barre[2].x1,pts_barre[2].y1,pts_barre[2].x2,pts_barre[2].y2);
